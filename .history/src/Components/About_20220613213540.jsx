...
import Articles3 from '../assets/images/Articles1.png'
const About = () => {
    const listCart=[
        {id:1,img:Articles1, data:'February 8, 2021', text:'The TikTok Algorithm: How to Get the Best Engagement',after:'Dianne Russell'},
        {id:2,<img:Articles2></img:Articles2>, data:'February 8, 2021', text:'The TikTok Algorithm: How to Get the Best Engagement',after:'Dianne Russell'},
